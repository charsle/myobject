...
$.extend(Dialog.prototype,{
	...
	init:function(){
		this.$ele = $('<div class="dialog" style="display:none;"><div class="dia-tit"></div><div class="dia-main"></div><div class="dia-close" action-type="close"><i class="glyphicon glyphicon-remove-circle"></i></div></div>');
		this.$diaTit = this.$ele.find(".dia-tit");
		this.$diaMain = this.$ele.find(".dia-main");
		this.$diaTit.text(this.options.title);
		this.$diaMain.html(this.options.content).css({width:this.options.width});
